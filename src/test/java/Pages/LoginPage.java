...
public class LoginPage {
    ...
    public static void enterUsername(WebDriver driver, String id) throws IOException {
        Map<String, String> values = reader.getKeyValuePair("login", "username");
         username = WebActions.findElement(driver, values);
        username.sendKeys(id);
        ExtentReportManager.logInfoWithScreenshot("username is entered");
    }

    public static void enterPassword(WebDriver driver, String id) throws IOException {
        Map<String, String> values = reader.getKeyValuePair("login", "password");
        password = WebActions.findElement(driver, values);
        password.sendKeys(id);
        ExtentReportManager.logInfoWithScreenshot("password is entered");
    }

    public static void login(WebDriver driver) throws IOException {
        Map<String, String> values = reader.getKeyValuePair("login", "login");
        login = WebActions.findElement(driver, values);
        login.click();
        ExtentReportManager.logInfoWithScreenshot("clicked on login button");
    }
    ...
    public static String getConfirmationMessage(WebDriver driver) throws InterruptedException, IOException {
        try {
            Map<String, String> values = reader.getKeyValuePair("login", "verifyLogin");
            verifyLogin =WebActions.findElement(driver, values);
            WebActions.moveToElement(driver,verifyLogin);
            ExtentReportManager.logInfoWithScreenshot("verify login by products tag");
            return verifyLogin.getText();
        } catch (Exception e) {
            return e.getMessage();
    ...
    public static String getInvalidConfirmationMessage(WebDriver driver) throws InterruptedException, IOException {
        try {
            Map<String, String> values = reader.getKeyValuePair("login", "verifyInvalidLogin");
            verifyInvalidLogin = WebActions.findElement(driver, values);
            ExtentReportManager.logInfoWithScreenshot("invalid login ");
            return verifyInvalidLogin.getText();
        } catch (Exception e) {
            return e.getMessage();
